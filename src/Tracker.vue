<template>
    <div class="flex justify-center items-center min-h-screen bg-gray-300">
      <div class="container mx-auto p-9 bg-gray rounded-lg shadow-lg border border-gray-300 bg-gray">
  ...
  <style scoped>
    ...
    .btn-primary {
      background-color: hsl(243, 90%, 38%);
      color: white;
      padding: 10px 20px;
      border: none;
      border-radius: 5px;
    ...
    .btn-secondary {
      background-color: hsl(331, 91%, 44%);
      color: white;
      padding: 8px 16px;
      border: none;
      border-radius: 5px;
    ...
    .btn-danger:hover {
      background-color: hsl(235, 96%, 36%);
    }
  
    .expenses-table-container {
      max-height: 400px;
      overflow-y: auto;
      border: 1px solid hsl(306, 96%, 36%);
      border-radius: 5px;
